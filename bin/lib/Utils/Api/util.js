...
var Util = {
	...
	easyRespond: function(result, err, defaultStatusCode, context, message) {
		
		var body = this.responseBody(result, err, defaultStatusCode || null, message || null);
		
		var response = this.responseObject(body);
		
		return context.succeed(response);
	
	},

	keepDataAsArray: function(data) {
	...
	parseEvent: function(event, allowEmptyValues) {
	...
	responseBody: function(data, err, defaultStatusCode, message) {
	...
	responseObject: function(responseBody, moreProperties) {
